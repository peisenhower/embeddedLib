...
uint8_t el_crc8 (uint8_t crc, const uint8_t *data, size_t length)
{
    size_t i;
...
uint16_t el_crc16 (uint16_t crc, const uint8_t *data, size_t length)
{
    size_t      count;
    uint16_t    temp;
